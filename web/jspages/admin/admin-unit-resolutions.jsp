...
<html lang="en">
    <head>
        ...
        <title>Admin · Unit Resolutions</title>
    ...
    <body onunload="reset()">
        ...
        <div class="overlay-menu">
            <ul id="menu2">
                ...
                <li><a class="over btn active" href="${pageContext.request.contextPath}/Admin/Unit_Resolutions">UNITS · Resolutions</a></li>
                    ...
                    <div id="menu">
                        ...
                        <div class="dropdown">
                            ...
                            <div id="dropdown" class="dropdown-content">
                                <a class="btn active" href="${pageContext.request.contextPath}/Admin/Unit_Resolutions">Resolutions</a>
