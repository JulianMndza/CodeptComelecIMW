...
<html lang="en">
    <head>
        ...
        <title>Admin · Unit College Constitution</title>
    ...
    <body onunload="reset()">
        ...
        <div class="overlay-menu">
            <ul id="menu2">
                ...
                <li><a class="over btn active" href="${pageContext.request.contextPath}/Admin/Unit_Constitution">UNITS · College Constitution</a></li>
        ...
        <div class="wrapper">
                    ...
                    <div id="menu">
                        ...
                        <div class="dropdown">
                            ...
                            <div id="dropdown" class="dropdown-content">
                                ...
                                <a class="btn active" href="${pageContext.request.contextPath}/Admin/Unit_Constitution">College Constitution</a>
                            </div>
                        </div>
            ...
            <div id="swup" class="container transition-fade">
                <h1><u>College Constitution Page Contents</u></h1>  
                <div class="unit-dropdown-contain">
                    ...
                    <div id="unit-<%out.print(i);%>" class="unit-content">
                        ...
                        <%
                            try {
                                if (conn != null) {
                                    ...
                                    } //to reset fileLink and docTitle if a unit has no consti
                                    else {
                                        fileLink = "";
                                        docTitle = "";
                                    }
                        %>
                        <div>
                            <form action="../AdminUpdateUnitConstitution">
                                ...
                                <input type="text" id="title" name="title" placeholder="Enter Document Title" value="<%out.print(docTitle);%>" maxlength="100" required>
                                <br>
