    ...
    <body>
        ...
        <div class="overlay-menu">
            <ul id="menu2">
                ...
                <li><a class="over btn active" href="${pageContext.request.contextPath}/Admin/Documents">DOCUMENTS</a></li>
                <br>
        ...
        <div class="wrapper">
            ...
            <nav id="sidenav">
                <div class="nav-wrapper">
                    ...
                    <div id="menu">
                        ...
                        <a class="btn active" href="${pageContext.request.contextPath}/Admin/Documents">DOCUMENTS</a>
                        <br>
            ...
            <div id="swup" class="container transition-fade">
                <h1><u>Documents Page Contents</u></h1>  
                <!--         
                    Existing Documents 
                -->
                <%
                ...
                <div>
                    <form action="#" method="post">
                        ...
                        <br>
                        <input type="submit" name="update_button" formaction="../UpdateDocumentServlet" value="Update Document" onclick="test()"/>
                        <input type="submit" name="archive_button" formaction="../ArchiveDocumentServlet" value="Archive Document" onclick="return confirm('Are you sure? Archived documents will no longer be editable.')" />
                    </form>
                </div> 
                <br>
                <%
                ...
                -->
                <div>
                    <form action="../AddDocumentServlet" method="post">
