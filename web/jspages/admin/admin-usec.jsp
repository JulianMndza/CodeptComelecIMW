    ...
    <body>
        ...
        <div class="overlay-menu">
            <ul id="menu2">
                ...
                <li><a class="over btn active" href="${pageContext.request.contextPath}/Admin/USEC">USEC</a></li>
        ...
        <div class="wrapper">
            ...
            <nav id="sidenav">
                <div class="nav-wrapper">
                    ...
                    <div id="menu">
                        ...
                        <a class="btn active" href="${pageContext.request.contextPath}/Admin/USEC">USEC</a>
            ...
            <div id="swup" class="container transition-fade">
                <h1><u>USEC Page Contents</u></h1>  
                <!--         
                    Current Document
                -->
                <div>
                    <form action="../UpdateUSECServlet" method="post">
