...
<html lang="en">
    <head>
        ...
        <title>Unit Editor · Executive Order</title>
    ...
    <body>
        ...
        <div class="overlay-menu">
            <ul id="menu2">
                ...
                <li><a class="over btn active" href="${pageContext.request.contextPath}/Unit_Editor/Unit_ExecutiveOrder">EXECUTIVE ORDER</a></li>
        ...
        <div class="wrapper">
            ...
            <nav id="sidenav">
                <div class="nav-wrapper">
                    ...
                    <div id="menu">
                        ...
                        <a class="btn active" href="${pageContext.request.contextPath}/Unit_Editor/Unit_ExecutiveOrder">EXECUTIVE ORDER</a>
            ...
            <div id="swup" class="container transition-fade">
                <h1><u>Executive Order Page Contents</u></h1> 
                <div class="unit-dropdown-contain">
                    ...
                    <div id="unit-1" class="unit-content">
                        ...
                        <%
                            try {
                                if (conn != null) {
                                    String query = "SELECT * FROM UNIT_EXECUTIVE_ORDER WHERE UNIT = ? AND STATUS = ?";
                        ...
                        <div>
                            <form action="#" method="post">
                                ...
                                <br>
                                <input type="submit" name="update_button" formaction="../AdminUpdateUnitExecutiveOrder" value="Update Document" onclick="test()"/>
                                <input type="submit" name="archive_button" formaction="../AdminArchiveUnitExecutiveOrder" value="Archive Document" onclick="return confirm('Are you sure? Archived documents will no longer be editable.')" />
                            </form>
                        </div> 
                        <br>
                        <%
                        ...
                        -->
                        <div>
                            <form action="../AdminAddUnitExecutiveOrder" method="post">
                                <input type="hidden" name="role" value="<%out.print(role);%>">
