...
<html lang="en">
    <head>
        ...
        <title>Unit Editor · Memorandum</title>
    ...
    <body>
        ...
        <div class="overlay-menu">
            <ul id="menu2">
                ...
                <li><a class="over btn active" href="${pageContext.request.contextPath}/Unit_Editor/Unit_Memorandum">MEMORANDUM</a></li>
            ...
            <nav id="sidenav">
                <div class="nav-wrapper">
                    ...
                    <div id="menu">
                        ...
                        <a class="btn active" href="${pageContext.request.contextPath}/Unit_Editor/Unit_Memorandum">MEMORANDUM</a>
