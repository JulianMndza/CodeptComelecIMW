...
<html lang="en">
    <head>
        ...
        <title>Unit Editor · College Constitution</title>
    ...
    <body>
        ...
        <div class="overlay-menu">
            <ul id="menu2">
                ...
                <li><a class="over btn active" href="${pageContext.request.contextPath}/Unit_Editor/Unit_Constitution">COLLEGE CONSTITUTION</a></li>
                <br>
        ...
        <div class="wrapper">
            ...
            <nav id="sidenav">
                <div class="nav-wrapper">
                    ...
                    <div id="menu">
                        ...
                        <a class="btn active" href="${pageContext.request.contextPath}/Unit_Editor/Unit_Constitution">COLLEGE CONSTITUTION</a>
                        <br>
            ...
            <div id="swup" class="container transition-fade">
                <h1><u>Constitution of the College Page Contents</u></h1>
