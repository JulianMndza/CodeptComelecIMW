...
<html lang="en">
    <head>
        ...
        <title>Central COMELEC · Resolutions</title>
    ...
    <body onload="document.body.style.opacity = '1'">
                ...
                <div id="menu">
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-content">
                            <a class="btn active" href="${pageContext.request.contextPath}/Unit_Resolution">RESOLUTIONS</a> 
        ...
        <div class="overlay-menu">
            <ul id="menu2">
                ...
                <li><a class="over btn active" href="${pageContext.request.contextPath}/Unit_Resolution">UNITS · RESOLUTIONS</a></li>
        ...
        <div id="swup" class="container transition-none">
            ...
            <div class="doc-content transition-right" >
                ...
                <div class="docu-wrapper">
                    ...
                    %>
                    <form action="Unit_Resolution_DocumentViewer" method="get" class="doc-box">
                ...
                <a href="${pageContext.request.contextPath}/Unit_Resolution">Back to Units: Resolutions</a>
            </div>
        </div>
        <!--         -->
        <!-- Content -->
