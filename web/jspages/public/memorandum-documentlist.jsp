...
<html lang="en">
    <head>
        ...
        <title>Central COMELEC · Memorandum</title>
    ...
    <body onload="document.body.style.opacity = '1'">
                ...
                <div id="menu">
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-content">
                            ...
                            <a class="btn active" href="${pageContext.request.contextPath}/Unit_Memorandum">MEMORANDUM</a>    
        ...
        <div class="overlay-menu">
            <ul id="menu2">
                ...
                <li><a class="over btn active" href="${pageContext.request.contextPath}/Unit_Memorandum">UNITS · MEMORANDUM</a></li>
        ...
        <div id="swup" class="container transition-none">
            ...
            <div class="doc-content transition-right" >
                ...
                <div class="docu-wrapper">
                    ...
                    %>
                    <form action="Unit_Memorandum_DocumentViewer" method="get" class="doc-box">
                ...
                <a href="${pageContext.request.contextPath}/Unit_Memorandum">Back to Units: Memorandum</a>
            </div>
        </div>
        <!--         -->
        <!-- Content -->
