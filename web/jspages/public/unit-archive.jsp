    ...
    <body onload="document.body.style.opacity = '1'">
        ...
        <div id="swup" class="container transition-none">
            <div class="heading-bg">
                <div class="heading">
                    ...
                    <div class="content transition-top">
                        <h1>Unit Archives</h1>
                        <p>Archived legal documents of all COMELEC units from previous school years</p>
                    </div>
                </div>
            </div>
            <div class="unit-content transition-right" >
                ...
                <div class="form-box">
                    <form action="Units_Archive_SelectYear" method="get" class="logo-wrapper">
                        <button type="submit" class="logo-content" >  
                            <input type="hidden" name="archivechosenunit" value="Central Commission on Elections">
                    ...
                    <form action="Units_Archive_SelectYear" method="get" class="logo-wrapper">
                        <button type="submit" class="logo-content" >  
                            <input type="hidden" name="archivechosenunit" value="UST-AMV College of Accountancy">
                    ...
                    <form action="Units_Archive_SelectYear" method="get" class="logo-wrapper">
                        <button type="submit" class="logo-content" >  
                            <input type="hidden" name="archivechosenunit" value="College of Architecture">
                    ...
                    <form action="Units_Archive_SelectYear" method="get" class="logo-wrapper">
                        <button type="submit" class="logo-content" >  
                            <input type="hidden" name="archivechosenunit" value="College of Commerce and Business Administration">
                    ...
                    <form action="Units_Archive_SelectYear" method="get" class="logo-wrapper">
                        <button type="submit" class="logo-content" >  
                            <input type="hidden" name="archivechosenunit" value="College of Education">
                    ...
                    <form action="Units_Archive_SelectYear" method="get" class="logo-wrapper">
                        <button type="submit" class="logo-content" >  
                            <input type="hidden" name="archivechosenunit" value="College of Fine Arts and Design">
                    ...
                    <form action="Units_Archive_SelectYear" method="get" class="logo-wrapper">
                        <button type="submit" class="logo-content" >  
                            <input type="hidden" name="archivechosenunit" value="College of Information and Computing Sciences">
                    ...
                    <form action="Units_Archive_SelectYear" method="get" class="logo-wrapper">
                        <button type="submit" class="logo-content" >  
                            <input type="hidden" name="archivechosenunit" value="College of Nursing">
                    ...
                    <form action="Units_Archive_SelectYear" method="get" class="logo-wrapper">
                        <button type="submit" class="logo-content" >  
                            <input type="hidden" name="archivechosenunit" value="College of Rehabilitation Sciences">
                    ...
                    <form action="Units_Archive_SelectYear" method="get" class="logo-wrapper">
                        <button type="submit" class="logo-content" >  
                            <input type="hidden" name="archivechosenunit" value="College of Science">
                    ...
                    <form action="Units_Archive_SelectYear" method="get" class="logo-wrapper">
                        <button type="submit" class="logo-content" >  
                            <input type="hidden" name="archivechosenunit" value="College of Tourism and Hospitality Management">
                    ...
                    <form action="Units_Archive_SelectYear" method="get" class="logo-wrapper">
                        <button type="submit" class="logo-content" >  
                            <input type="hidden" name="archivechosenunit" value="Conservatory of Music">
                    ...
                    <form action="Units_Archive_SelectYear" method="get" class="logo-wrapper">
                        <button type="submit" class="logo-content" >  
                            <input type="hidden" name="archivechosenunit" value="Faculty of Arts and Letters">
                    ...
                    <form action="Units_Archive_SelectYear" method="get" class="logo-wrapper">
                        <button type="submit" class="logo-content" >  
                            <input type="hidden" name="archivechosenunit" value="Faculty of Civil Law">
                    ...
                    <form action="Units_Archive_SelectYear" method="get" class="logo-wrapper">
                        <button type="submit" class="logo-content" >  
                            <input type="hidden" name="archivechosenunit" value="Faculty of Engineering">
                    ...
                    <form action="Units_Archive_SelectYear" method="get" class="logo-wrapper">
                        <button type="submit" class="logo-content" >  
                            <input type="hidden" name="archivechosenunit" value="Faculty of Medicine and Surgery">
                    ...
                    <form action="Units_Archive_SelectYear" method="get" class="logo-wrapper">
                        <button type="submit" class="logo-content" >  
                            <input type="hidden" name="archivechosenunit" value="Faculty of Pharmacy">
                    ...
                    <form action="Units_Archive_SelectYear" method="get" class="logo-wrapper">
                        <button type="submit" class="logo-content" >  
                            <input type="hidden" name="archivechosenunit" value="Ecclesiastical Faculties (Canon Law, Philosophy, and Sacred Theology)">
                    ...
                    <form action="Units_Archive_SelectYear" method="get" class="logo-wrapper">
                        <button type="submit" class="logo-content" >  
                            <input type="hidden" name="archivechosenunit" value="Institute of Physical Education">
                    ...
                    <form action="Units_Archive_SelectYear" method="get" class="logo-wrapper">
                        <button type="submit" class="logo-content" >  
                            <input type="hidden" name="archivechosenunit" value="Education High School">
                    ...
                    <form action="Units_Archive_SelectYear" method="get" class="logo-wrapper">
                        <button type="submit" class="logo-content" >  
                            <input type="hidden" name="archivechosenunit" value="Junior High School">
                    ...
                    <form action="Units_Archive_SelectYear" method="get" class="logo-wrapper">
                        <button type="submit" class="logo-content" >  
                            <input type="hidden" name="archivechosenunit" value="Senior High School">
