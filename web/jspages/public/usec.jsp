...
<html lang="en">
    <head>
        ...
        <title>Central COMELEC · USEC</title>
    ...
    <body onload="document.body.style.opacity = '1'">
        ...
        <nav id="navbar">
            <div class="nav-wrapper">
                ...
                <div id="menu">
                    ...
                    <a class="btn active" href="${pageContext.request.contextPath}/USEC">USEC</a>
        ...
        <div class="overlay-menu">
            <ul id="menu2">
                ...
                <li><a class="over btn" href="${pageContext.request.contextPath}/Unit_Constitution">UNITS · CONSTITUTION</a></li>
                ...
                <li><a class="over btn active" href="${pageContext.request.contextPath}/USEC">USEC</a></li>
            ...
            <div class="heading-bg">
                <div class="heading">
                    ...
                    <div class="content transition-top">
                        <h1>USEC</h1>
                        <p>UST Students' Election Code</p>
                    </div>
                </div>
            </div>
